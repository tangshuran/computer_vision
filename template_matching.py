...
#cv2.imshow("cv2.bitwise_and(roi,roi,mask = mask)",cv2.bitwise_and(roi,roi,mask = mask))
#cv2.imshow("cv2.bitwise_and(roi,roi,mask = mask_inv)",cv2.bitwise_and(roi,roi,mask = mask_inv))
...
cv2.imshow("img1_with_logo",img1)
